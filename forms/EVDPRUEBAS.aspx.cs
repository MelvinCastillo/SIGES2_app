...
{
    public partial class EVDPRUEBAS : System.Web.UI.Page
    {
        ...
        protected void _Nuevo(string CodigoGrupo)
        {
            ...
            { 
                ...
                this.dtConsultaDatos = DB.ExecuteAdapter(string.Format("PR_EVD_PRUEBAS_NUEVO  @PACIENTE = '{0}',  @USUARIO = '{1}', @CENTRO = '{2}', @GRUPO = '{3}'", (object)PACIENTE, (object)USUARIO, (object)CENTRO, CodigoGrupo.ToString()));
        ...
        protected void _Save(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem repeaterItem in this.rpevaluacion.Items)
            {
                ...
                this.xQueryValues.Add(OBJTxtpuntuacion.Text.ToString());
                ...
                DataTable dataTable2 = DB.ExecuteAdapter("PR_EVD_PRUEBAS_GUARDAR", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure); if (dataTable2.Rows.Count != 0) ;
         ...
         protected void _VerDetallePruebas(object sender, EventArgs e)
        {
            ...
            this.xQuery = "PR_EVD_PRUEBASBUSCA";
        ...
        public void _Buscar(object sender, EventArgs e)
        {
            if (Request.QueryString["CurrentPAX_ROWGUID"] != null)
            {
                ...
                DataTable dtconsulta = DB.ExecuteAdapter("PR_EVD_PRUEBAS_HISTORICO", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure);
        ...
        public void _BuscarPruebas(object sender, EventArgs e)
        {
            ...
            {  
                ...
                */
                ...
                foreach (DataRow row in (InternalDataCollectionBase)DB.ExecuteAdapter(string.Format("PR_EVD_PRUEBAS_GRUPOS")).Rows)
