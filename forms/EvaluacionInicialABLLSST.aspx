<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="EvaluacionInicialABLLSST.aspx.cs" Inherits="CAID_V2.forms.EvaluacionInicialABLLSST" %>
            ...
            <div class="row-fluid">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-reorder"></i>Historico de la Evaluación Inicial ABLLS - Salón Tecnológico                       
                            </h3> 
                                <div class="actions">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td class="hidden-480">
                                                    <asp:DropDownList ID="ddlDATO" CssClass="input-medium" runat="server" SelectedValue='<%# Eval("DATO")%>'>
                                                        ...
                                                        <asp:ListItem Value="I">Independiente</asp:ListItem>
                                                        <asp:ListItem Value="AF">Ayuda Fisica</asp:ListItem>
                                                        <asp:ListItem Value="AP">Ayuda Posicional</asp:ListItem>
                                                        <asp:ListItem Value="AG">Ayuda Gestual</asp:ListItem>
                                                        <asp:ListItem Value="AV">Ayuda Verbal</asp:ListItem>
                                                        <asp:ListItem Value="NC">No lo hace</asp:ListItem>
                                                    </asp:DropDownList>
                                                </td>
