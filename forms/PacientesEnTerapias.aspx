<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="PacientesEnTerapias.aspx.cs" Inherits="CAID_V2.forms.PacientesEnTerapias" %>
    ...
    <asp:Panel runat="server" ID="pnlData">
        <div class="box box-bordered"> 
            ...
            <div id="pndetallado1" runat="server" class="control-group"> 
                <div class="box-title">
                    <h3>
                        <i class="icon-edit"></i>Pacientes recibiendo Terapias</h3>
                    <div class="actions">
                                    ...
                                    <tr>
                                       <%-- <td><strong><%# Eval("NUMERO")%></strong></td>  --%>
                                        ...
                                        <td><%# Eval("CATEGORIADESC")%></td>  
                                         <td><%# Eval("EdadMeses")%></td> 
                                        <td><%# Eval("SEXOID")%></td>
                                        <td><%# Eval("AGENTSOCIALID")%></td> 
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                        </tbody>
