...
{
    public partial class EstadisticasCitas : System.Web.UI.Page
    {
        ...
        protected void _Show(object sender, EventArgs e)
        {
            if (ddespecialidad.SelectedValue.ToString() != "")
            {
                ...
                this.xQuery = "PR_CITAS_ESTADISTICAS";
                pnresumen.Visible = false;
                pndetallado1.Visible = false;
                //REPORTE RESUMIDO
        ...
        private string ROWSGXID
        {
            get
            {
                ...
                {
                    Session.Add("CURRENTUSR_SGXID", Request.QueryString["XCURRENTUSR_SGXID"].ToString());
                }
