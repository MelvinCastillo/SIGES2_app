...
{
    public partial class AP_ENTREVISTAPADRES : System.Web.UI.Page
    {
        ...
        protected void _Nuevo(object sender, EventArgs e)
        {
            if (Request.QueryString["CurrentPAX_ROWGUID"] != null)
            {
                ...
                this.dtConsultaDatos = DB.ExecuteAdapter(string.Format("PR_AP_ENTREVISTAPADRES_NUEVO  @PACIENTE = '{0}',  @USUARIO = '{1}', @CENTRO = '{2}'", (object)PACIENTE, (object)USUARIO, (object)CENTRO));
        ...
        protected void _Save(object sender, EventArgs e)
        {
            ...
            this.xQueryParameters.Add("@ComoseentretieneTelevision");
            this.xQueryParameters.Add("@ComoseentretienePelota");
            this.xQueryParameters.Add("@ComoseentretieneJuguetes");
            this.xQueryParameters.Add("@ComoseentretieneObservarobjetos");
            this.xQueryParameters.Add("@ComoseentretieneOtros");
            ...
            foreach (RepeaterItem repeaterItem in this.rpevaluacion.Items)
            {
                ...
                DataTable dataTable2 = DB.ExecuteAdapter("PR_AP_ENTREVISTAPADRES_GUARDAR", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure); if (dataTable2.Rows.Count != 0) ;
         ...
         protected void _VerDetalle(object sender, EventArgs e)
        {
            ...
            this.xQuery = "PR_AP_ENTREVISTAPADRESBUSCA";
            ...
            if (dtEvaluacionCompleta.Rows.Count > 0)
            {
                ...
                ddlComoseentretieneTelevision.SelectedValue = dtRowEvaluacionCompleta["ComoseentretieneTelevision"].ToString();
                ddlComoseentretienePelota.SelectedValue = dtRowEvaluacionCompleta["ComoseentretienePelota"].ToString();
                ddlComoseentretieneJuguetes.SelectedValue = dtRowEvaluacionCompleta["ComoseentretieneJuguetes"].ToString();
                ddlComoseentretieneObservarobjetos.SelectedValue = dtRowEvaluacionCompleta["ComoseentretieneObservarobjetos"].ToString();
                ddlComoseentretieneOtros.SelectedValue = dtRowEvaluacionCompleta["ComoseentretieneOtros"].ToString();
        ...
        public void _Buscar(object sender, EventArgs e)
        {
            if (Request.QueryString["CurrentPAX_ROWGUID"] != null)
            {
                ...
                DataTable dtconsulta = DB.ExecuteAdapter("PR_AP_ENTREVISTAPADRES_HISTORICO", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure);
