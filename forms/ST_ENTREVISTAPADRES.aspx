<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="ST_ENTREVISTAPADRES.aspx.cs" Inherits="CAID_V2.forms.ST_ENTREVISTAPADRES" %>
        ...
        <asp:Panel runat="server" ID="pnlData" Visible="false">
                    ...
                    <div class="col-sm-12">
                        <div class="box box-color box-bordered">
                            <div class="box-title box-color">
                                <h3><i class="fa fa-list"></i>I. Datos Personales</h3>
                                <div class="actions">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea runat="server" name="txtCentroeducativo " id="txtCentroeducativo" rows="1" class="input-block-level" data-rule-required="true" placeholder="Digite Aqui"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="box box-color box-bordered">
                            <div class="box-title box-color">
                                <h3>
                                    <i class="fa fa-list"></i>I.I Nucleo Familiar </h3>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            <h3><i class="fa fa-list"></i>II.Información General</h3>
                        </div>
                        <div>
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-column form-bordered'>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    &nbsp
                                    <input runat="server" name="txtPersonaSesionNombre" id="txtPersonaSesionNombre" type="text" class="input-block-level">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <%--4-Alergias:--%>
                                            <div class="control-group">
                                                <label for="lblAlergias" class="control-label col-sm-2">
                                                    Alergias:</label>
                                                <div class="controls">
                                                    <textarea runat="server" name="txtAlergias" id="txtAlergias" rows="1" class="input-block-level" data-rule-required="true" placeholder="Digite Aqui"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <%--4-ConQuienVive:--%>
                                            <div class="control-group">
                                                <label for="lblConQuienVive" class="control-label col-sm-2">
                                                    Con Quién Vive?</label>
                                                <div class="controls">
                                                    <textarea runat="server" name="txtConQuienVive" id="txtConQuienVive" rows="1" class="input-block-level" data-rule-required="true" placeholder="Digite Aqui"></textarea>
                                                </div>
                                            </div>
                                            <%--5-Comentarios Generales:--%>
                                            <div class="control-group">
                                                <label for="lblComentariosGenerales" class="control-label col-sm-12">
                                                    Comentarios Generales</label>
                                                <div class="controls">
                                                    <textarea runat="server" name="txtComentariosGenerales" id="txtComentariosGenerales" rows="2" class="input-block-level" data-rule-required="true" placeholder="Digite Aqui"></textarea>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            <h3><i class="fa fa-list"></i>III. Comunicación y Relación </h3>
                        </div>
                        <div>
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-column form-bordered'>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="control-group">
                                                <label for="lblNivelAcademico" class="control-label col-sm-2">
                                                    -	Habilidades sociales (relación con sus iguales)</label>
                                                <div class="controls">
                                                    <textarea runat="server" name="txtHabilidadessociales" id="txtHabilidadessociales" rows="4" class="input-block-level" data-rule-required="true" placeholder="Interacción Social con sus Iguales"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            <%--1-Habilidades sociales (relación con sus compañeros y adultos)--%>
                                            <div class="control-group">
                                                <label for="lblInteraccionconAdultos" class="control-label col-sm-2">
                                                    -	Habilidades sociales (relación con adultos)</label>
                                                <div class="controls">
                                                    <textarea runat="server" name="txtInteraccionconAdultos" id="txtInteraccionconAdultos" rows="4" class="input-block-level" data-rule-required="true" placeholder="Interacción con los adultos"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row" style="display: none;">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            <h3><i class="fa fa-list"></i>IV. Rutinas</h3>
                        </div>
                        <div>
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-column form-bordered'>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            <h3><i class="fa fa-list"></i>IV. Juego</h3>
                        </div>
                        <div>
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-bordered'>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <%--1--	¿Con cuáles de estos aparatos electrónicos está familiarizado?  --%>
                                            <div class="control-group">
                                                <label class="control-label col-sm-12">¿Con cuáles de estos aparatos electrónicos está familiarizado? </label>
                                                <div class="controls">
                                                    ...
                                                    <label>Tableta &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                                    ...
                                                    <label>Nintendo&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                                    ...
                                                    <label>Celular&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                                    ...
                                                    <label>Otros&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
                                                    ...
                                                    <label>Especifique&nbsp&nbsp&nbsp&nbsp </label>
                                                    <textarea runat="server" name="txtAparatoElectronicoOtrosEspecifique" id="txtAparatoElectronicoOtrosEspecifique" rows="1" class="input-block-level" data-rule-required="true" placeholder="Digite Aqui"></textarea>
            ...
            <%--V. Familia / Manejo de la disciplina  --%>
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            <h3><i class="fa fa-list"></i>V. Familia / Manejo de la disciplina  </h3>
                        </div>
                        <div>
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-bordered'>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <%--1--Cuál es la Reacción del niño cuando está enojado? --%>
                                            <div class="control-group">
                                                <label class="control-label col-sm-12">¿Qué conductas emite el niño cuando se enoja?</label>
                                                <div class="controls">
                                                    <textarea runat="server" name="txtReacciondelninoenojado" id="txtReacciondelninoenojado" rows="4" class="input-block-level" data-rule-required="true" placeholder="Cuál es la Reacción del niño cuando está enojado?"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
            ...
            <div class="row" style="display: none;">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            <h3><i class="fa fa-list"></i>VI.	Escuela</h3>
                        </div>
                        <div>
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-bordered'>
