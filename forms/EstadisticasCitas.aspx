<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadisticasCitas.aspx.cs" Inherits="CAID_V2.forms.RPTSEGUIMIENTOCASOS" %>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="EstadisticasCitas.aspx.cs" Inherits="CAID_V2.forms.EstadisticasCitas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Panel runat="server" ID="pnlData">
        <div class="box box-bordered">
            <div class="box-title">
                <h3>
                    <i class="icon-edit"></i>Consulta de Citas por Servicio</h3>
            </div>
                    ...
                    <table class="table table-bordered dataTable dataTable-scroll-x dataTable-tools dataTable-grouping">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-350">ASISTIO</th>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <%--<td class="hidden-480"><%# Eval("FECHA")%></td>--%> 
                                          <td class="hidden-480"><%#Convert.ToDateTime(Eval("FECHA")).ToString("dd/MM/yyyy")%></td>  
                                        <td class="hidden-480"><%# Eval("TIPO")%></td>  
                                        <td class="hidden-480"><%# Eval("DESDE")%></td> 
                                        <td class="hidden-480"><%# Eval("HASTA")%></td> 
                                        <td class="hidden-350"><%# Eval("ASISTIO")%></td>
                                        <td class="hidden-350"><%# Eval("CITAESTADO")%></td>
