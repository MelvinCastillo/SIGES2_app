                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:DropDownList ID="dpgrado" runat="server" class='select2-me input-block-level'>
                                                ...
                                                <asp:ListItem>1ro Básica</asp:ListItem>
                                                <asp:ListItem>2do Básica</asp:ListItem>
                                                <asp:ListItem>3ro Básica</asp:ListItem>
                                                <asp:ListItem>4to Básica</asp:ListItem>
                                                <asp:ListItem>5to Básica</asp:ListItem>
                                                <asp:ListItem>6to Básica</asp:ListItem>  
                                                <asp:ListItem>1ro Media</asp:ListItem>
                                                <asp:ListItem>2do Media</asp:ListItem>
                                                <asp:ListItem>3ro Media</asp:ListItem>
                                                <asp:ListItem>4to Media</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="span6">
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-bordered'>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <asp:DropDownList ID="dptipocategoria" runat="server" class='select2-me input-block-level'>
                                                ...
                                                <asp:ListItem>Ninguno</asp:ListItem>
                                                <asp:ListItem>Escuela Regular</asp:ListItem>
                                                <asp:ListItem>Escuela Especial</asp:ListItem>
                                                <asp:ListItem>Aula de Recursos</asp:ListItem>
                                    ...
                                    <%-- MAESTRO  asistente--%>
                                    <div class="control-group">
                                        <label for="lblmaestroAsistente" class="control-label" style="color: black">
                                            Maestro Asistente</label>
                                        <div class="controls">
                                            <input runat="server" name="txtmaestroAsistente" id="txtmaestroAsistente" type="text" class="input-block-level"
                                                data-rule-required="true" style="text-transform: uppercase">
                                            <br />
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Cancelar</a>--%>
                                            <button type="button" id="Button1" runat="server" onserverclick="_BackMain" class="btn">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <iframe id="mapagoogle" class="show" allowfullscreen="" frameborder="0" width="100%"
                                height="650" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyADvUGYP5rvDFzaewS4w-Qi2P5t6qJ7NKc+&amp;q=Dominican+republic%2C+distrito+nacional%2C+ensanche+miramar%2C+los+corales&amp;zoom=17&amp;maptype=satellite"></iframe>
                            <script type="text/javascript">
