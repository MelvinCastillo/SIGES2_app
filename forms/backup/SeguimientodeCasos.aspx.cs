...
#pragma warning restore CS0169 // The field 'SeguimientodeCasos.xQuery' is never used
        ...
        protected void _Show(object sender, EventArgs e)
        {
            ...
            if (DB.ExecuteNonQuery(string.Format("[PR_SeguimientoCasos] '{0}','{1}','{2}','{3}'", (object)DPPaciente.SelectedValue.ToString(), (object)txtcomentario.Text.ToString().Trim(), (object)USERNAME.ToString(), (object)ROWSGXID.ToString())))
            {
