<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="PacientesEgresados.aspx.cs" Inherits="CAID_V2.forms.PacientesEgresados" %>
    ...
    <asp:Panel runat="server" ID="pnlData">
        <div class="box box-bordered"> 
            ...
            <div id="pndetallado1" runat="server" class="control-group"> 
                <div class="box-title">
                    <h3>
                        <i class="icon-edit"></i>Pacientes Egresados</h3>
                    <div class="actions">
                                ...
                                <ItemTemplate>
                                    <tr>
                                       <%-- <td><strong><%# Eval("NUMERO")%></strong></td>  --%>
                                        ...
                                        <td><%#Convert.ToDateTime(Eval("ROWMDTE")).ToString("dd/MM/yyyy")%></td>
