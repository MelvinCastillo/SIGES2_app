...
{
    public partial class AgendasRegistro : System.Web.UI.Page
    {
        ...
        private string ROWSGXID
        {
            get
            {
                return Request.QueryString["USUARIO"].ToString();  //this.Session["CURRENTUSR_SGXID"].ToString();
            }
        }
        ...
        protected void _Save(object sender, EventArgs e)
        {
          ...
          //  this.xQueryValues.Add((object)this.PREDIAGNOSTICO1);
