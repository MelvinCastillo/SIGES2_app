...
#pragma warning disable CS0169 // The field 'Escolaridad.CURRENTUSR_SGXID' is never used
#pragma warning disable CS0169 // The field 'Escolaridad.CURRENTUSR_SGXID' is never used
#pragma warning disable CS0169 // The field 'Escolaridad.CurrentUSR_ROWGUID' is never used
        String CURRENTUSR_SGXID;

#pragma warning restore CS0169 // The field 'Escolaridad.CurrentUSR_ROWGUID' is never used
#pragma warning restore CS0169 // The field 'Escolaridad.CURRENTUSR_SGXID' is never used
#pragma warning disable CS0169 // The field 'Escolaridad.IDPaciente' is never used
#pragma warning restore CS0169 // The field 'Escolaridad.CURRENTUSR_SGXID' is never used
#pragma warning disable CS0169 // The field 'Escolaridad.VarValida' is never used
#pragma warning disable CS0169 // The field 'Escolaridad.CurrentUSR_ROWGUID' is never used
        String CurrentUSR_ROWGUID;
#pragma warning restore CS0169 // The field 'Escolaridad.IDPaciente' is never used
#pragma warning restore CS0169 // The field 'Escolaridad.VarValida' is never used
#pragma warning restore CS0169 // The field 'Escolaridad.CurrentUSR_ROWGUID' is never used
#pragma warning disable CS0169 // The field 'Escolaridad.IDPaciente' is never used
        string IDPaciente;
#pragma warning restore CS0169 // The field 'Escolaridad.IDPaciente' is never used
...
#pragma warning restore CS0169 // The field 'Escolaridad.VarValida' is never used
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request.QueryString["idpaciente"].ToString().Trim() != "DATA")
                {
                    //BUSCO  los distritos*/
                    ...
                    if (dataTable2.Rows.Count != 0)
                    {
                        ...
                        txtmaestroAsistente.Value = row2["maestroasistente"].ToString();
                    }
        ...
        protected void _Save(object sender, EventArgs e)
        {
            ...
            string strmaestroAsistente = txtmaestroAsistente.Value.ToString();
            ...
            this.xQueryParameters.Add((object)"@MaestroAsistente");
            this.xQueryValues.Add((object)strmaestroAsistente);
        ...
        {
            if (Request.QueryString["idpaciente"].ToString() != null)
                PACIENTE = Request.QueryString["idpaciente"].ToString();
            this.Response.Redirect("http://caidsiges01:8000/PAX00000.aspx?X=" + PACIENTE);
