<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RptActividadesxPXPorFecha.aspx.cs" Inherits="CAID_V2.forms.RptActividadesxPXPorFecha" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Actividades de  Pacientes Por Fecha</title>
    ...
    <!-- Wizard -->
    <script src="../js/plugins/wizard/jquery.form.wizard.min.js" type="text/javascript"type="text/javascript"></script>
...
<body>
    ...
    <div class="box box-bordered">
        <div class="box-title">
            <h3>
                <i class="icon-edit"></i>Reporte Actividades de  Pacientes por Fecha</h3>
        </div>
            ...
            <div class='form-horizontal form-bordered'> 
                ...
                <div class="form-actions">
                 <%--onclick="return btnPrint_onclick()"--%>
                    ...
                    <a href='http://caidsiges01:8000/INDEX.aspx' class="btn"><i class="icon-arrow-left"></i>&nbsp
                        Regresar</a>
                </div>
            </div>
        </div>
