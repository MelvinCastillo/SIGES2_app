...
namespace CAID_V2
{
    public partial class Site2 : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //firstName = (string)(Session["CURRENTUSR_LOGIN"]);
            //context.Session["CURRENTUSR_LOGIN"] = firstName;
            
            
            //this.lblUsuario.InnerText = (string)(context.Session["CURRENTUSR_LOGIN"]);
        ...
        internal void _Notify2(string msg)
        {
            this.Page.ClientScript.RegisterClientScriptBlock(this.Page.GetType(), "NotifyMsg", "toast({message:'" + msg + "'}); setTimeout(function() {  },900)", true);
        }
