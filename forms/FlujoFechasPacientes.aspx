<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="FlujoFechasPacientes.aspx.cs" Inherits="CAID_V2.forms.FlujoFechasPacientes" %>
    ...
    <asp:Panel runat="server" ID="pnlData">
        <div class="box box-bordered"> 
            ...
            <div id="pndetallado1" runat="server" class="control-group"> 
                <div class="box-title">
                    <h3>
                        <i class="icon-edit"></i>Flujo Fechas Pacientes</h3>
                    <div class="actions">
                    ...
                    <table class="table table-bordered dataTable dataTable-scroll-x dataTable-tools">
                        <thead>
                            <tr> 
                                ...
                                <th class="hidden-480">Fec.Evaluacion Diagnostico</th>
                                <th class="hidden-480">Fec. Plan Terapeutico</th>
                                <th class="hidden-480">Fec. Egreso</th>
                                </tr>
                        </thead>
                        <tbody>
                                ...
                                <ItemTemplate>
                                    <tr>
                                       <%-- <td><strong><%# Eval("NUMERO")%></strong></td>  --%>
                                        ...
                                        <td><%# Eval("Fechaadmision")%></td>   
                                        <td><%# Eval("FechaRutaBasica")%></td> 
                                        <%--<td><%# Eval("Dias_ParaserAdmitido")%></td> 
                                        <td><%# Eval("Dias_ParaEntrarRutaBasica")%></td> --%>
                                        <td><%# Eval("FechaEvaluacionInicial")%></td> 	
                                        <td><%# Eval("FechaPlanTerapeutico")%></td> 	
                                        <td><%# Eval("FechaEgreso")%></td> 
