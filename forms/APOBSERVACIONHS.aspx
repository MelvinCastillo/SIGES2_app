<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="APOBSERVACIONHS.aspx.cs" Inherits="CAID_V2.forms.APOBSERVACIONHS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
            ...
            <div class="row-fluid">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-reorder"></i>Historico de Observacion Habilidades Sociales
                            </h3>
                            <div class="actions">
        ...
        <asp:panel runat="server" id="pnlData" visible="false">
            ...
            <div class="col-sm-12">
               <div class="box-title" id="Div1" runat="server">
                  <div class="control-group">  
                <h4><i class="icon-edit"></i>Seleccione el Formulario</h4>
                        <div class="controls">
            ...
            <%--DATOS DEL FORMULARIO DE OBSERVACION HABILIDADES SOCIALES--%>
                ...
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div>
                            <div class="box-title">
                                <h3>
                                    <i class="icon-edit"></i>Observacion de Habilidades Sociales</h3>
                                <div class="actions">
  ...
  --%>                                             
                                                     <asp:DropDownList ID="ddlDATO" CssClass="input-xxlarge" runat="server"  SelectedValue='<%# Eval("DATO")%>' > 
                                                         <asp:ListItem Value="">-- Seleccione --</asp:ListItem>
                                                        <asp:ListItem Value="1">N/A</asp:ListItem>
                                                        <asp:ListItem Value="2">NIVEL APROPIADO DEL DESARROLLO</asp:ListItem>
                                                        <asp:ListItem Value="3">NO ES CIERTO</asp:ListItem>         
                                                        <asp:ListItem Value="4">ALGO CIERTO</asp:ListItem>
                                                        <asp:ListItem Value="5">LIGERAMENTE POCO/DEMASIADO</asp:ListItem>
                                                        <asp:ListItem Value="6">MUY CIERTO </asp:ListItem>
                                                        <asp:ListItem Value="7">SIGNIFICATIVAMENTE POCO/DEMASIADO</asp:ListItem>
                                                    </asp:DropDownList>
                                                    </td>
                                                <td class="hidden-480">
                                                    <asp:TextBox ID="txtObservacion" CssClass="input-large" Text='<%# Eval("OBSERVACION")%>' runat="server" placeholder="Digite Aqui" class="form-control" Style="text-align: left;"></asp:TextBox>
                                                </td>
