<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmisionesInstitucionRelacionadaPX.aspx.cs"
    Inherits="CAID_V2.forms.AdmisionesInstitucionRelacionadaPX" %>
            ...
            <div class="row-fluid">
                <div class="col-sm-12">
                    <div class="control-group">
                        <asp:DropDownList ID="ddInstituciones" runat="server" CssClass="select2-me input-block-level"
                            data-rule-required="true" AutoPostBack="True" OnSelectedIndexChanged="ddInstituciones_SelectedIndexChanged">
                            <%--OnSelectedIndexChanged="cmbPais_SelectedIndexChanged"--%>
                        </asp:DropDownList> 
                        <div class="actions">
                            <%----%>
                            <button type="button" id="tbnAdd" runat="server" validationgroup="pnlEdit"
                                class="btn" data-dismiss="modal" onserverclick="_Save" visible="False">
