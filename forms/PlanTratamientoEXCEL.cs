...
{
    public class PlanTratamientoEXCEL : Page
    {
        ...
        private string ROWSGXID
        {
            get
            {
                return Request.QueryString["CURRENTUSR_SGXID"].ToString();  //this.Session["CURRENTUSR_SGXID"].ToString();
            }
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            if (ROWUSERID.Trim() == string.Empty)
        ...
        private void _Iniciar()
        {
            ...
            foreach (DataRow row in (InternalDataCollectionBase)DB.ExecuteAdapter(string.Format("SGX00100S4 @ROWSGXID = '{0}', @TERID = '{1}'", ROWSGXID.Trim(), ROWUSERID)).Rows)
        ...
        protected void _Show(object sender, EventArgs e)
        {
            ...
            this.xQueryValues.Add(this.cmbPaciente2.SelectedValue);
        ...
        protected void _VerDetallesPlan(object sender, EventArgs e)
        {
            ...
            this.Session.Add("REPORT_DATASOURCE", (object)string.Format("[HCX00300R1] @ROWSGXID = '{0}',@REFGUID = '{1}',@ROWUSERID = '{2}',@TERID = '{3}'", (object)this.ROWSGXID, (object)str, (object)this.ROWUSERID, this.ROWUSERID));
