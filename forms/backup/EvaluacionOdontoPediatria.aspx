<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true"
    CodeBehind="EvaluacionOdontoPediatria.aspx.cs" Inherits="CAID_V2.forms.EvaluacionOdontoPediatria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container-fluid" id="content">
        ...
        <asp:ScriptManager ID="SMPlanTratamiento" runat="server">
        </asp:ScriptManager>
                            ...
                            <div class='form-horizontal form-column form-bordered'>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="control-group">
                                            <label for="lblModalidaddeatencionodontológica" class="control-label col-sm-6">
                                                Modalidad Atención:  
                                            </label>
                                            <div class="controls">
                            ...
                            <div class="box-content nopadding">
                                <div class='form-horizontal form-column form-bordered'>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="control-group">
                                                <label class="control-label col-sm-2">Grupo Familiar?:</label>
                                                <div class="controls">
                                                    <%-- <div class="col-lg-12">--%>
                                            ...
                                            <table class="table table-bordered">
                                                <thead runat="server">
                                                    ...
                                                    <tr>
                                                        <th></th>
                                                        <th>
                                                            <input type="text" name="txtnombreMedicina" id="txtnombreMedicina" placeholder="Digite Aqui" class="form-control" runat="server" required></th>
                                                        ...
                                                        <th>
                                                            <input type="text" name="txtposologia" id="txtposologia" placeholder="Digite Aqui" class="form-control" runat="server" required></th>
                                                        ...
                                                        <th>
                                                            <input type="text" name="txtdosis" id="txtdosis" placeholder="Digite Aqui" class="form-control" runat="server" required></th>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:DropDownList ID="ddlRiesgocariogenico" CssClass="input-medium" runat="server">
                                                            <asp:ListItem Value="">-- Seleccione --</asp:ListItem>
                                                            <asp:ListItem Value="Alto">Bueno</asp:ListItem>
                                                            <asp:ListItem Value="Moderado">Regular</asp:ListItem>
                                                            <asp:ListItem Value="Bajo">Malo</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="control-group">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:DropDownList ID="ddlAlimentacionactual" CssClass="input-medium" runat="server">
                                                            <asp:ListItem Value="">-- Seleccione --</asp:ListItem>
                                                            <asp:ListItem Value="Leche">Leche</asp:ListItem>
                                                            <asp:ListItem Value="Jugos">Jugos</asp:ListItem>
                                                            <asp:ListItem Value="Frutas">Frutas</asp:ListItem>
                                                            <asp:ListItem Value="Cereal">Cereal</asp:ListItem>
                                                            <asp:ListItem Value="Carnes">Carnes</asp:ListItem>
                                                            <asp:ListItem Value="Vegetales">Vegetales</asp:ListItem>
                                                            <asp:ListItem Value="Harinas">Harinas</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
        ...
        <asp:Panel runat="server" ID="pnodontograma">
            ...
            <link href="http://localhost:12503/css/odontograma/bootstrap.css" rel="stylesheet" />
            <link href="http://localhost:12503/css/odontograma/bootstrap.min.css" rel="stylesheet" />
            <script src="http://localhost:12503/js/jquery.min.js"></script>
            <div class="row-fluid">
                <div class="col-sm-12">
                    <div class="box box-color box-bordered">
                        <div class="box-title box-color">
                            ...
                            <div class="actions">
                                <button type="button" id="Button1" runat="server"
                                    class="btn btn-default" data-dismiss="modal" onclick='triggerDownload(document.getElementById("MainContent_pnodontograma").innerHTML)'>
                                    <i class="icon-plus-sign"></i>&nbsp Imprimir</button> 
                                <%--<button id="BtnImprimir" class="form-control lg" CssClass="input-lg" onclick='triggerDownload(document.getElementById("MainContent_pnodontograma").innerHTML)'>Imprimir</button>--%>
                            </div>
                        ...
                        <div class="box-content nopadding">
                            <div class="row">
                                <div class="container">
                                    <div class="panel-body" id="pnodontogramaBody" runat="server">
                                        <div class="row">
                                                    ...
                                                    <div class="panel-body" align="center">
                                                        <div class="btn-group" data-toggle="buttons">
                                                            ...
                                                            <%--<label id="puente" class="btn btn-primary">
                                                                <input id="option5" autocomplete="off" name="options" type="radio"> Puente </input>
                                                            </label>--%>
                                                            <label id="Radiografia" class="btn btn-satgreen">
                                                                <input type="radio" name="options" autocomplete="off">Radiografia</label>
                                                            <%--<label id="borrar" class="btn btn-default">
                                                                <input  id="option6" autocomplete="off" name="options" type="radio"> Borrar </input>
                                                            </label>
                                                            &nbsp;--%>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right">
                                                            <span style="display: inline:block;">Pieza Extraída</span> =
                                                             <img style="display: inline:block;" src="http://localhost:12503/img/extraccion.png">
                                                            <br>
                                                            <span style="display: inline:block;">Para Extraer</span> =
                                                             <img style="display: inline:block;" src="http://localhost:12503/img/paraextraer.png">
                                                            <br>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="container"> 
                                      <asp:Repeater ID="RPODONTOGRAMA" runat="server" Visible="false">
                                        <ItemTemplate>
                                            <%# Eval("OdontogramaURL")%>
                                        </ItemTemplate>
                                    </asp:Repeater>
        ...
        <asp:Panel runat="server" ID="PNPROCEDIMIENTOSAREALIZAR">
            <div class="row-fluid">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlalertaPacientesdadodealta" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlalertaDestartrajesSupragingival" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlalertaTerapiaMiofuncional" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                            <asp:ListItem Value="7">Semanal</asp:ListItem>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlalertaBarnizFluor" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                            <asp:ListItem Value="7">Semanal</asp:ListItem>
                                                            <asp:ListItem Value="15">Quincenal</asp:ListItem>
                                                            <asp:ListItem Value="30">Mensual</asp:ListItem>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlalertaprofilaxis" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlalertatraumadental" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                            <asp:ListItem Value="30">Mensual</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <asp:DropDownList ID="ddlAparatosOrtondonciaInterceptivaConvencionales" CssClass="input-xlarge" runat="server">
                                                            <asp:ListItem Value="0">-- Seleccione --</asp:ListItem>
                                                            <asp:ListItem Value="7">Semanal</asp:ListItem>
                                                            <asp:ListItem Value="15">Quincenal</asp:ListItem>
                                                            <asp:ListItem Value="30">Mensual</asp:ListItem>
