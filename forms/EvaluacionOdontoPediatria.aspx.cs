...
namespace CAID_V2.forms
{
    public partial class EvaluacionOdontoPediatria : System.Web.UI.Page
    {
        ...
        private string xControlFocus;
        private bool postbackodonto;
        public string CurrentPAX_ROWGUID, usuario, CURRENTUSR_SGXID, CurrentUSR_TERID,
                      ckfrecuenciacepillado1, ckHabitosbucales1, CKOrtodonciadientesprimarios1,
                      ckOrtodonciadientesdenticionmixtapermanente1, ddlPrescripciones1, ckObjectivosMiofuncionalMyobrace1, 
                      ckAntecedentesMedicosGrales, ckAlimentacionActual;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                xControlFocus = "";
                // pnodontogramadb.Visible = false;
                xNombreArchivo.Value = CurrentPAX_ROWGUID + "_" + Guid.NewGuid().ToString().ToUpper();
                LlenarLista();
                CargarDetallesTodos();
                _CargarMultimedias();
                CargarMaestro(sender, e);
                postbackodonto = false;
                ddlImpresiondiagnostica.Focus();
                //ddlImpresiondiagnostica.EnableViewState = true;

            }
            else
            { 
                if (postbackodonto == true)
                {
            ...
            #endregion
            //Page.LoadComplete += new EventHandler(_SaveMaestro);
        }
        /*
        void Page_LoadComplete(object sender, EventArgs e)
        {
            // call your download function
            //lblImpresiondiagnostica.InnerText = @"C:\Users\user\Downloads\" + xNombreArchivo.Value + ".html";
            //lblModalidaddeatencionodontologica.InnerText = this.Server.MapPath(@".\records\" + xNombreArchivo.Value + ".html");
            try
            {
                GuardarOdontogrmaServer(sender, e);
            }
            catch
            { }
        } */
        ...
        { 
            ...
            this.xQueryParameters.Add("@AtencedentesMedicosGeneralesotros");
            ...
            /*Checklist antecedentes medicos generales */
            for (int index = 0; index < this.txtantecedentesmedicosgenerales.Items.Count; ++index)
            {
                if (this.txtantecedentesmedicosgenerales.Items[index].Selected)
                    ckAntecedentesMedicosGrales = ckAntecedentesMedicosGrales + "," + this.txtantecedentesmedicosgenerales.Items[index].Value.Trim();
            }
            if (ckAntecedentesMedicosGrales != "")
                ckAntecedentesMedicosGrales = ckAntecedentesMedicosGrales.Remove(0, 1);

            /*Checklist Alimentacion Actual */ 
            for (int index = 0; index < this.ddlAlimentacionactual.Items.Count; ++index)
            {
                if (this.ddlAlimentacionactual.Items[index].Selected)
                    ckAlimentacionActual = ckAlimentacionActual + "," + this.ddlAlimentacionactual.Items[index].Value.Trim();
            }
            if (ckAlimentacionActual != "")
                ckAlimentacionActual = ckAlimentacionActual.Remove(0, 1);
            ...
            this.xQueryValues.Add(ddlImpresiondiagnostica.Value);
            ...
            this.xQueryValues.Add(ckAntecedentesMedicosGrales.ToString());
            ...
            this.xQueryValues.Add(ckAlimentacionActual.ToString());
            ...
            this.xQueryValues.Add(txturlodontograma1.Value);//odontogramaURL 
            ...
            this.xQueryValues.Add(txtantecedentesmedicosgeneralesotros.Text.ToString());
            ...
            if (dtOdontopediatria.Rows.Count != 0)
            {
                ...
                if (row2["Conteo"].ToString() != "0")
                {
                    ...
                    Response.Redirect(Request.RawUrl);
                        //GuardarOdontogramaasHTML(xNombreArchivo.Value);
                    }
                else
                ...
                Notify("No se pudo almacenar la informacion", "error");
            buscoodonto(sender,e);


        }
        private void CargarMaestro(object sender, EventArgs e)
        { 
            CurrentPAX_ROWGUID = Request.QueryString["CurrentPAX_ROWGUID"].ToString();
            CURRENTUSR_SGXID = Request.QueryString["CURRENTUSR_SGXID"].ToString();
            ...
            if (dtMaestro.Rows.Count != 0)
            {
                ...
                ddlImpresiondiagnostica.Value = rowMaestro["ImpresionDiagnotisca"].ToString();
                ...
                strchecklist = rowMaestro["AtencedentesMedicosGenerales"].ToString().Split(chArray);
                if (strchecklist[0] != "")
                {
                    foreach (string str in strchecklist)
                        this.txtantecedentesmedicosgenerales.Items.FindByValue(str).Selected = true;
                }
                ...
                strchecklist = rowMaestro["AlimentacionActual"].ToString().Split(chArray);
                if (strchecklist[0] != "")
                {
                    foreach (string str in strchecklist)
                        this.ddlAlimentacionactual.Items.FindByValue(str).Selected = true;
                }
                ...
                if (rowMaestro["OdontogramaURL"].ToString().Trim() != "")
                {
                    txturlodontograma1.Value = rowMaestro["OdontogramaURL"].ToString();
                    buscoodonto(sender, e); }

                else
                { pnodontogramadb.Visible = false; }
                txtantecedentesmedicosgeneralesotros.Text = rowMaestro["AtencedentesMedicosGeneralesotros"].ToString();
            }
            else
            {
                ...
                txtantecedentesmedicosgeneralesotros.Text = "";
       ...
       /* public void GuardarOdontogramaasHTML(string NombreArchivo)
        {
           ...
           // ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardaOdontograma", "triggerDownload('" + NombreArchivo + "');", true);
            ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardaOdontograma", "onGetURLOdontograma();", true);
            //txturlodontograma.Value; = txturlodontograma.Value;
        }*/

        public void GuardarOdontogramaasHTML(object sender,EventArgs e)
        {
            // triggerDownload(document.getElementById("MainContent_pnodontograma").innerHTML
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardaOdontograma", "onGetURLOdontograma();", true);
            //txturlodontograma.Value; = txturlodontograma.Value;
            //urlOdontograma_Click(sender, e);
        }
        public void GuardarOdontogrmaServer(object sender, EventArgs e)
        { /*
            string ArchivoOrigen = @"C:\Users\user\Downloads\" + xNombreArchivo.Value + ".html";
            string ArchivoDestino = this.Server.MapPath(@".\records\" + xNombreArchivo.Value + ".html");
            int milliseconds = 4000;
            System.Threading.Thread.Sleep(milliseconds); 

            if (File.Exists(ArchivoOrigen))
            {
                Notify("VOY VOY", "success");
        ...
        protected void _SaveDetallesHermanos(object sender, EventArgs e)
        {
            ...
            this.xQueryParameters.Add("@TipoEdad");
            this.xQueryValues.Add(DdlTipoEdad.SelectedValue);
        ...
        protected void _SaveTratamientoRealizado(object sender, EventArgs e)
        {
            ...
            ddlTratamientoRealizado.SelectedValue = string.Empty;
        ...
        protected void LlenarLista()
        {
            ...
            this.txtantecedentesmedicosgenerales.Items.Clear();
            DataTable dtantecedentesmedicosgenerales = DB.ExecuteAdapter(string.Format("SELECT ROWGUID as codigo,NOMBRE as Descripcion FROM vANTE_MED_ODO", this.xQueryValues, CommandType.Text));
            foreach (DataRow row in (InternalDataCollectionBase)dtantecedentesmedicosgenerales.Rows)
            {
                this.txtantecedentesmedicosgenerales.Items.Add(new ListItem(row["Descripcion"].ToString(), row["codigo"].ToString()));
            ...
            this.ddlTratamientoRealizado.Items.Clear();
            this.ddlTratamientoRealizado.Items.Add(new ListItem("-- SELECCIONE --", string.Empty));
        ...
        protected void urlOdontograma_Click(object sender, EventArgs e)

        {
            txturlodontograma1.Value = txturlodontograma.Value;
            //_SaveMaestro(sender, e);
            //ddlImpresiondiagnostica.Focus();
            //ScriptManager.RegisterStartupScript(this, this.GetType(), "GuardaOdontograma", "scrollToDiv();", true);
            postbackodonto = true;
        }
            
        protected void buscoodonto(object sender, EventArgs e)
        {
            /*BUSCO EL MAESTRO PARA REFRESCAR */
            this.xQueryParameters.Clear();
            this.xQueryValues.Clear();
            this.xQueryParameters.Add("@PACIENTE");
            this.xQueryValues.Add(CurrentPAX_ROWGUID.ToString());
            ...
            if (dtMaestro.Rows.Count != 0)
            {
                ...
                pnodontogramaBody.Visible = false;
                pnodontogramadb.Visible = true;
                RPODONTOGRAMA.DataSource = dtMaestro;
                RPODONTOGRAMA.DataBind();
            ...
            {
                pnodontogramadb.Visible = false;
                pnodontogramaBody.Visible = true;
            }
        } 

         
        protected void _NuevoOdontograma(object sender, EventArgs e)
        {
            /*BUSCO EL MAESTRO PARA REFRESCAR */
            this.xQueryParameters.Clear();
            this.xQueryValues.Clear();
            ...
            this.xQueryParameters.Add("@Centro");
            this.xQueryValues.Add(CURRENTUSR_SGXID.ToString());
            this.xQuery = "PR_ODPMaestroLimpiarUrlOdontograma";
            DataTable dtMaestro = DB.ExecuteAdapter(this.xQuery, this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure);
            if (dtMaestro.Rows.Count != 0)
            { 
                buscoodonto(sender, e);
                txturlodontograma1.Value = "";
                pnodontogramaBody.Visible = true ;
                pnodontogramadb.Visible = false;
                Response.Redirect(Request.RawUrl);
                //Server.Transfer("EvaluacionOdontopediatria.aspx");
                //txturlodontograma1.Focus();
                //SMPlanTratamiento.RegisterAsyncPostBackControl(pnodontogramaBody);
                
                //UpdatePanel9.Update();
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "CreateOdontograma", "createOdontogram();", true);
        ...
        { 
            ...
            this.xQueryParameters.Add("@Centro");
            this.xQueryValues.Add(CURRENTUSR_SGXID.ToString());
            this.xQuery = "PR_ODPMaestro_Alertas";
            DataTable dtAlertas = DB.ExecuteAdapter(this.xQuery, this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure);
            if (dtAlertas.Rows.Count != 0)
            {
                RPALERTAS.DataSource = dtAlertas;
                RPALERTAS.DataBind(); 
            } 
        }
