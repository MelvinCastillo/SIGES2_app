...
{
    public partial class EvaluacionInicialABLLS : System.Web.UI.Page
    {
        ...
        protected void _Nuevo(object sender, EventArgs e)
        {
            if (Request.QueryString["CurrentPAX_ROWGUID"] != null)
            {
                ...
                this.dtConsultaDatos = DB.ExecuteAdapter(string.Format("PR_EVALUACIONABLLS_NUEVO  @PACIENTE = '{0}',  @USUARIO = '{1}', @CENTRO = '{2}'", (object)PACIENTE, (object)USUARIO, (object)CENTRO));
        ...
        protected void _Save(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem repeaterItem in this.rpevaluacion.Items)
            {
                ...
                this.xQueryValues.Add(OBJCRITERIODATO.Text.ToString());
                ...
                DataTable dataTable2 = DB.ExecuteAdapter("PR_EVALUACIONABLLS_GUARDAR", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure); if (dataTable2.Rows.Count != 0) ;
         ...
         protected void _VerDetalle(object sender, EventArgs e)
        {
            ...
            this.xQuery = "PR_EVALUACIONABLLSBUSCA";
        ...
        public void _Buscar(object sender, EventArgs e)
        {
            if (Request.QueryString["CurrentPAX_ROWGUID"] != null)
            {
                ...
                DataTable dtconsulta = DB.ExecuteAdapter("PR_EVALUACIONABLLS_HISTORICO", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure);
