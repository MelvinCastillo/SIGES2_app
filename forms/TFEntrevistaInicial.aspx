...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container-fluid" id="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtNombreMadre" id="txtNombreMadre" placeholder="Digite Aqui" class="form-control" disabled runat="server">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtCelulareMadre" id="txtCelulareMadre" class="input-block-level mask_phone"
                                                    placeholder="(999) 999-9999" runat="server">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtTelefonoTrabajomadre" id="txtTelefonoTrabajomadre" class="input-block-level mask_phone" placeholder="(999) 999-9999" runat="server">
                                            </div>
                                        </div>
                                        <%-- 5- Telefono Trabajo--%>
                                        <div class="control-group">
                                            <label for="lblCorreoElectronicoMadre" class="control-label col-sm-2">
                                                Correo Electronico Madre</label>
                                            <div class="controls">
                                                <input type="text" name="txtCorreoMadre" id="txtCorreoMadre" class="input-block-level email" aria-describedby="emailHelp"
                                                    placeholder="Digite Aqui" runat="server">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtNombrepadre" id="txtNombrepadre" placeholder="Digite Aqui" class="form-control" disabled runat="server">
                                            </div>
                                        </div>
                                        <%-- 2- Celular del padre--%>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtcorreopadre" id="txtcorreopadre" class="input-block-level email" aria-describedby="emailHelp"
                                                    placeholder="Digite Aqui" runat="server">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtNombreTutor" id="txtNombreTutor" placeholder="Digite Aqui" class="form-control" disabled runat="server">
                                            </div>
                                        </div>
                                        <%-- 2- Celular del Tutor--%>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="txtcorreoTutor" id="txtcorreoTutor" class="input-block-level email" aria-describedby="emailHelp"
                                                    placeholder="Digite Aqui" runat="server">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" name="txtparticipantesotros" id="txtparticipantesotros" placeholder="Digite Otros Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    <%--2- Personas a Cargo--%>
                                    <div class="control-group">
                                        ...
                                        <div class="controls" style="text-align: left;">
                                            ...
                                            <input type="text" name="txtpersoncargootros" id="txtpersoncargootros" placeholder="Digite Otros Aqui" class="form-control" runat="server">
                                            Comentarios:</label>
                                                <input type="text" name="txtComentariopersoncargootros" id="txtComentariopersoncargootros" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls" style="text-align: left;">
                                            ...
                                            <input type="text" name="txtmanejadisciplinaOtros" id="txtmanejadisciplinaOtros" placeholder="Digite Otros Aqui" class="form-control" runat="server">
                                            Comentarios:</label>
                                                <input type="text" name="txtComentariomanejadisciplinaotros" id="txtComentariomanejadisciplinaotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Comentarios:</label>
                                                <input type="text" name="txtestilocrianzaComentario" id="txtestilocrianzaComentario" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    <%--5-Estado Civil--%>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Otros:</label>
                                                <input type="text" name="txtEstadoCivilotros" id="txtEstadoCivilotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls" style="text-align: left;">
                                            ...
                                            <input type="text" name="txtpersonavivenencasaComentario" id="txtpersonavivenencasaComentario" placeholder="Digite Otros Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Otros:</label>
                                                <input type="text" name="txtddlrelacionpadresotros" id="txtddlrelacionpadresotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Otros:</label>
                                                <input type="text" name="txtrelacionpacientemadreOtros" id="txtrelacionpacientemadreOtros" placeholder="Digite Aqui" class="form-control" runat="server">
                                            Comentarios:</label>
                                                <input type="text" name="txtrelacionpacientemadreComentario" id="txtrelacionpacientemadreComentario" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Otros:</label>
                                                <input type="text" name="txtrelacionpacientepadreOtros" id="txtrelacionpacientepadreOtros" placeholder="Digite Aqui" class="form-control" runat="server">
                                            Comentarios:</label>
                                                <input type="text" name="txtrelacionpacientepadreComentario" id="txtrelacionpacientepadreComentario" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Otros:</label>
                                                <input type="text" name="txtrelacionpacientecuidadorOtros" id="txtrelacionpacientecuidadorOtros" placeholder="Digite Aqui" class="form-control" runat="server">
                                            Comentarios:</label>
                                                <input type="text" name="txtrelacionpacientecuidadorComentario" id="txtrelacionpacientecuidadorComentario" placeholder="Digite Aqui" class="form-control" runat="server">
                                        </div>
                                    </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="container-fluid">
                                    <div class="col-sm-6">
                                        ...
                                        <asp:DropDownList ID="ddHermanosFallecidos" runat="server" CssClass="select2-me input-block-level"
                                            data-rule-required="true">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Cuantos?:</label>
                                        <input type="text" name="txthermanosCuantos" id="txthermanosCuantos" placeholder="Digite Aqui" class="form-control" runat="server">
                                    </div>

                                    <div class="col-sm-6">
                                        <label>Causa:</label>
                                        <input type="text" name="txthermanosCausa" id="txthermanosCausa" placeholder="Digite Aqui" class="form-control" runat="server">
                                    </div>
                                    <div class="control-group" id="pnHermanosDetalles">
                                        <%--DETALLE DE HERMANOS--%>
                                        <%--13-Datos generales de Hermanos--%>
                                        <div class="col-sm-12">
                                            <label for="lbldatoshermanos">DATOS GENERALES DE HERMANOS:</label>
                                        </div>
                                        <div class="nopadding">
                                            <table class="table table-bordered">
                                                <thead runat="server">
                                                    <tr>
                                                        ...
                                                        <th>Edad</th>
                                                        <th class="hidden-350">Diagnostico (Si Aplica y Especificar)</th>
                                                        <th class="hidden-350">Tipo Relacion</th>
                                                        <th class="hidden-350"></th>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                            <input type="text" name="txtnombreHermano" id="txtnombreHermano" placeholder="Digite Aqui" class="form-control" runat="server" required></th>
                                                        ...
                                                        <th class="hidden-350">
                                                            <input type="text" name="TxtDiagnosticoHermano" id="TxtDiagnosticoHermano" placeholder="Digite Aqui" class="form-control" runat="server"></th>
                                                        <th class="hidden-350">
                                                            <input type="text" name="TxtTipoRelacionHermano" id="TxtTipoRelacionHermano" placeholder="Digite Aqui" class="form-control" runat="server"></th>
                                                        <th class="hidden-350">
                                                            <div class="actions">
                                                                <button type="button" id="btnAgregarHermano1" runat="server" validationgroup="pnlEdit"
                                                                    commandargument='<%# Eval("ROWGUID")%>' class="btn btn-blue" data-dismiss="modal" onserverclick="_SaveDetallesHermanos">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="btnDelete" CssClass="btn btn-red" runat="server" Text="Eliminar"
                                                                        ...
                                                                        OnClientClick="return confirm('¿Está seguro que desea eliminar este registro?');" CommandName="DeleteDetHermanos" OnClick="_DELETE"><i class="icon-remove-sign">&nbsp Eliminar</i></asp:LinkButton>

                                                                    <%-- <div class="actions">
                                                                            <button type="button" id="btnDelete1" runat="server" validationgroup="pnlEdit"
                                                                                class="btn btn-danger" data-dismiss="modal" onserverclick="_DELETE" commandname="DeleteDetHermanos">
                                                                                <i class="icon-remove-sign"></i>&nbsp Eliminar</button>
                                                                        </div>--%>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                Otros:</label>
                                                <input type="text" name="txtconductaeinteraccionotros" id="txtconductaeinteraccionotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                Otros:</label>
                                                <input type="text" name="txtconductaeinteraccionadultosotros" id="txtconductaeinteraccionadultosotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea runat="server" name="expectativasactuales" id="expectativasactuales" rows="8" class="input-block-level" data-rule-required="true" placeholder="Digite Aqui"></textarea>
                                            </div>
                                        </div>
        ...
        <div id="divconfidencial" runat="server">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Comentarios:
                                                <input type="text" name="txtpacientesospechamaltratoComentarios" id="txtpacientesospechamaltratoComentarios" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Motivo:
                                                <input type="text" name="txtfamiliaenprocesoComentarios" id="txtfamiliaenprocesoComentarios" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Otros:
                                                <input type="text" name="txtsituacionesquegeneranotros" id="txtsituacionesquegeneranotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                                    Comentarios:
                                                <input type="text" name="txtsituacionesquegeneranComentarios" id="txtsituacionesquegeneranComentarios" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Especifique:
                                                <input type="text" name="txtAntecedentesMedicosMadreEspecifique" id="txtAntecedentesMedicosMadreEspecifique" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="txtDiagnosticoosospechatrastornootros" id="txtDiagnosticoosospechatrastornootros" placeholder="Digite Otros Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="ddlRecibeTratamientopsicologico" runat="server" CssClass="select2-me input-block-level"
                                                        data-rule-required="true">
                                                        <asp:ListItem Value="0">-- SELECCIONE --</asp:ListItem>
                                                        <asp:ListItem Value="SI">SI</asp:ListItem>
                                                        <asp:ListItem Value="NO">NO</asp:ListItem>
                                                    ...
                                                    Motivo:
                                                <input type="text" name="txtRecibeTratamientopsicologicomotivo" id="txtRecibeTratamientopsicologicomotivo" placeholder="Digite Aqui" class="form-control" runat="server">
                                                    Profesional/institucion que le asiste:
                                                <input type="text" name="txtRecibeTratamientopsicologicoProfesional" id="txtRecibeTratamientopsicologicoProfesional" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Motivo:
                                                <input type="text" name="txtRecibeTratamientopsiquiatricomotivo" id="txtRecibeTratamientopsiquiatricomotivo" placeholder="Digite Aqui" class="form-control" runat="server">
                                                    Profesional/institucion que le asiste:
                                                <input type="text" name="txtRecibeTratamientopsiquiatricoProfesional" id="txtRecibeTratamientopsiquiatricoProfesional" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="txtAntecedentesdrogodependientes" id="txtAntecedentesdrogodependientes" placeholder="Digite Otros Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <label for="lblDatosrelevantespadre">
                                                        DATOS RELEVANTES SOBRE EL PADRE:</label>
                                                    </br>
                                                  <label for="lblDatosrelevantespadre">
                                                      Informacion del Padre:</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Especifique:
                                                <input type="text" name="txtAntecedentesMedicospadreEspecifique" id="txtAntecedentesMedicospadreEspecifique" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            <%--2. Diagnostico o sospecha de trastorno Mental:--%>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="txtDiagnosticoosospechatrastornopadreotros" id="txtDiagnosticoosospechatrastornopadreotros" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            <%--Recibe Tratamiento psicologico:--%>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Motivo:
                                                <input type="text" name="txtRecibeTratamientopsicologicopadremotivo" id="txtRecibeTratamientopsicologicopadremotivo" placeholder="Digite Aqui" class="form-control" runat="server">
                                                    Profesional/institucion que le asiste:
                                                <input type="text" name="txtRecibeTratamientopsicologicopadreProfesional" id="txtRecibeTratamientopsicologicopadreProfesional" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            <%--Recibe Tratamiento psiquiatrico:--%>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Motivo:
                                                <input type="text" name="txtRecibeTratamientopsiquiatricopadremotivo" id="txtRecibeTratamientopsiquiatricopadremotivo" placeholder="Digite Aqui" class="form-control" runat="server">
                                                    Profesional/institucion que le asiste:
                                                <input type="text" name="txtRecibeTratamientopsiquiatricopadreProfesional" id="txtRecibeTratamientopsiquiatricopadreProfesional" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            <%--Antecedentes drogodependientes:--%>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    Otros:
                                                <input type="text" name="txtAntecedentesdrogodependientespadre" id="txtAntecedentesdrogodependientespadre" placeholder="Digite Aqui" class="form-control" runat="server">
                                                </div>
                                            </div>
                                            <%--Otras informaciones de interes:--%>
                                            <div class="control-group">
