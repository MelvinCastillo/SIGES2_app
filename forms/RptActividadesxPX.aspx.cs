...
{
    public partial class RptActividadesxPX : System.Web.UI.Page
    {
        private ArrayList xQueryParameters = new ArrayList();
        private ArrayList xQueryValues = new ArrayList();
#pragma warning disable CS0169 // The field 'RptActividadesxPX.xCommand' is never used
#pragma warning disable CS0169 // The field 'RptActividadesxPX.xCommand' is never used
#pragma warning disable CS0169 // The field 'RptActividadesxPX.xQuery' is never used
        private string xCommand;
#pragma warning restore CS0169 // The field 'RptActividadesxPX.xCommand' is never used
#pragma warning restore CS0169 // The field 'RptActividadesxPX.xQuery' is never used
#pragma warning restore CS0169 // The field 'RptActividadesxPX.xCommand' is never used
#pragma warning disable CS0169 // The field 'RptActividadesxPX.xQuery' is never used
...
#pragma warning restore CS0169 // The field 'RptActividadesxPX.xQuery' is never used
        ...
        protected void _Show(object sender, EventArgs e)
        {
            ...
            ROWSGXID = Request.QueryString["LOCALIDAD"].ToString();
                ...
                this.Session.Add("REPORT_URL", (object)"~/reports/RPTACTIVIDAESXPX.rpt");
                ...
                this.Session.Add("REPORT_DATASOURCE", (object)string.Format("PR_PACIENTESxACTIVIDADES @RECORDID = '{0}', @ROWSGXID = '{1}',@USRNAME = '{2}',@FECHA1 = '{3}',@FECHA2 = '{4}'", (object)this.DPPaciente.SelectedValue.ToString(), (object)ROWSGXID.ToString(), (object)USERNAME.ToString(), (object)this.txtDesde.Value.ToString(), (object)this.txtHasta.Value.ToString()));
